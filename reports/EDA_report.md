...
'Order_ID' was excluded because It doesn't provide a operatinal factor in order to predicting delivery time.
...
- **Traffic level impact**: 'Traffic_Level' is likely one of the strongest drivers of delivery time, as a higer traffic usually results in longer delivery time.
- **Distance effect**: 'Distance_km' is expected to have a direct relationship with delivery timer-longer distance typically results in longer delivery time.
...
- **Weather condition**: 'Weather' may influence delivery time (specificly rain or fog), as It can reduce speed and increase caution while driving.
