...
## Overview
The model that I selected (Linear Regression) achieved **MAE of 6.06**, **RMSE of 8.95**, and **R^2 of 0.82**, which indicates good performance. However... some delivery scenarios are likely more difficult to predict than others.
...
The model is expected to make larger error when There are complex or unusal delivery situations, such as:
 ...
 - **Rainy or other adverse weather conditions**
