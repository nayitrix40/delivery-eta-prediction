...
**Traffic_level** and **weather** also played an important variable, which confirms that external operational conditions affect delivery performance.
